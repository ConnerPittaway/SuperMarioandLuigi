...
CharacterLuigi::CharacterLuigi(SDL_Renderer* renderer, std::string imagePath, Vector2D startPosition, LevelMap* map, LevelLoader* load) : Character(renderer, imagePath, startPosition, map)
{
	mRenderer = renderer;
...
void CharacterLuigi::Render(Camera* cam, float deltaTime)
{
